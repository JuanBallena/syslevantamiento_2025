...
<div align="center">
<form  class="myform" name="datos" action="proceso_cot/C_modifica_cotitular.php"  method="post" onSubmit="return datos_minimos_cotitular()" autocomplete="off">
                        ...
                        <div align='left' id='capa_oculta1_".($i)."' style='display: none; color: red;'>"; generaDep($i); echo "</div> </td>
                           ...
                           echo "<div align='left'>"; verifica_ubigeo_cotitulares('pro',2,$i); echo "</div>
                            ...
                            <div align='left' id='capa_oculta3_".($i)."' style='display: none; color: red'><select disabled='disabled' name='distritos".($i)."' id='distritos".($i)."'>
									  ...
									  <td colspan='3'><span class='Estilo1' id='cambiar_".($i)."' onClick='javascript:return muestra_y_oculta_cot(".($i).");'>Cambiar UBIGEO</span></td>
