...
if ($bc == 1) {
    ...
    echo "<meta http-equiv='refresh' content='1;url=http://".$_SERVER['HTTP_HOST']."/syslevantamiento/form_inicio.php'/>";
}
//libre=1 -> representa que estamos considerando que podemos elegir otra ficha
//existe=2 -> representa la existencia de una ficha individual con el mismo c�digo referencial


//	header( "refresh:1;url=http://".$_SERVER['SERVER_NAME']."/sisfichas/fichaCotitularidad/fichaCotitularidad.php" );
//	echo "<meta http-equiv='refresh' content='1;url=http://".$_SERVER['HTTP_HOST']."/sisfichas/fichaCotitularidad/nro_cotitular.php'/>";
