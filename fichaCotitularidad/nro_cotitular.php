...
<form name="envio" method="post"  onsubmit="javascript: return nro_cotitulares();" autocomplete="off">
  <table width="980" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td>
    <table class="myform" width="680" border="0" >
        <tr>
          <td colspan="3" bgcolor="#0052A4"><div align="center">
            <p class="Estilo1"> FICHA CATASTRAL COTITULAR</p>
            </div></td>
        </tr>
        <tr>
        ...
        <tr>
            <td width="480"><div align="right" class="Estilo5">INGRESE N° DE TITULARES
            ...
            <td width="472">
              <div align="left">
                <input name="nro_titulares" type="text" id="nro_titulares" size="21" maxlength="4"   style="text-align:center;" <?php echo $N;?>/>
                </div></td>
         </tr>
         <tr><td>&nbsp;</td></tr>
        <tr>
						...
						<tr>
						 ...
						 <tr>
							...
							<td width='13%' height='24'><div align='left'>CÓDIGO DE REFERENCIA CATASTRAL </div></td>
                                        ...
                                        <td><div align='center'>
                                          <input name='dg_entrada' type='text' class='2' id='dg_entrada' size='2' maxlength='2' ".$N.' '.$DC." />
                                        </div></td>
                                        <td><div align='center'>
                                          <input name='dg_piso' type='text' class='2' id='dg_piso' size='2' maxlength='2' ".$N.' '.$DC." />
                                        </div></td>
                                        <td><div align='center'>
                                          <input name='dg_unidad' type='text' class='2' id='dg_unidad' size='2' maxlength='3' ".$N.' '.$DC." />
                                        </div></td>
                                        <td><div align='center'>
						 ...
						 <tr><td>&nbsp;</td></tr>
						  <tr>
						    ...
						    <td colspan='11'><div align='left'>
                              <input  type='text' name='nro_ficha' id='nro_ficha' maxlength='7' size='7' style='text-align:center' onkeypress='javascript:return validar_numeros(event)' onchange='javascript:valida_nro_ficha_C(this)' />
                            </div></td>
						  </tr>
