...
function edit_fichas() {
  ...
  var antiguo = document.getElementById('referencia').value;
  ...
  var tiphu = document.getElementById('cmb_tipohu').value;
 ...
 */
  ...
  if (sw == 0) {
    ...
    if (document.getElementById('forma1').checked) {
      document.envio.action =
        'funciones/consulta_numero_2.php?nro=' + num + '&tipo=01&edit=1&pdf=1';
    } else if (document.getElementById('forma2').checked) {
      document.envio.action =
        'funciones/consulta_ref_2.php?nro=' + antiguo + '&tipo=01&edit=1&pdf=1';
      ...
      document.envio.action =
        'funciones/consulta_estafi.php?nro=' + estafi + '&tipo=01&edit=1&pdf=1';
    } else if (document.getElementById('forma5').checked) {
      document.envio.action =
        'funciones/consulta_tipvia.php?nro=' + tipvia + '&tipo=01&edit=1&pdf=1';
    } else if (document.getElementById('forma6').checked) {
      document.envio.action =
        'funciones/consulta_tipopu.php?nro=' + tipopu + '&tipo=01&edit=1&pdf=1';
      ...
      document.envio.action =
        'funciones/consulta_claspr.php?nro=' + claspr + '&tipo=01&edit=1&pdf=1';
    } else if (document.getElementById('forma9').checked) {
      document.envio.action =
        'funciones/consulta_predca.php?nro=' + predca + '&tipo=01&edit=1&pdf=1';
    } else if (document.getElementById('forma10').checked) {
      document.envio.action =
        'funciones/consulta_tipotitu.php?nro=' + tipoti + '&tipo=01&edit=1&pdf=1';
    } else if (document.getElementById('forma11').checked) {
      document.envio.action =
        'funciones/consulta_condtitu.php?nro=' + condti + '&tipo=01&edit=1&pdf=1';
    ...
    if (document.getElementById('forma1').checked) {
      document.envio.action =
        'funciones/consulta_numero_2.php?nro=' + num + '&tipo=02&edit=1&pdf=1';
    } else if (document.getElementById('forma2').checked) {
      document.envio.action =
        'funciones/consulta_ref_2.php?nro=' + antiguo + '&tipo=02&edit=1&pdf=1';
    } else if (document.getElementById('forma3').checked) {
      document.envio.action = 'funciones/consulta_cuc_2.php?nro=' + cuc + '&tipo=02&edit=1&pdf=1';
    } else if (document.getElementById('forma4').checked) {
      document.envio.action =
        'funciones/consulta_estafi.php?nro=' + estafi + '&tipo=02&edit=1&pdf=1';
    } else if (document.getElementById('forma5').checked) {
      document.envio.action =
        'funciones/consulta_tipvia.php?nro=' + tipvia + '&tipo=02&edit=1&pdf=1';
    } else if (document.getElementById('forma7').checked) {
    ...
    if (document.getElementById('forma1').checked) {
      document.envio.action =
        'funciones/consulta_numero_econo.php?nro=' + num + '&tipo=03&edit=1&pdf=1';
    } else if (document.getElementById('forma2').checked) {
      document.envio.action =
        'funciones/consulta_ref_econo.php?nro=' + antiguo + '&tipo=03&edit=1&pdf=1';
    } else if (document.getElementById('forma3').checked) {
      document.envio.action =
        'funciones/consulta_cuc_econo.php?nro=' + cuc + '&tipo=03&edit=1&pdf=1';
    } else if (document.getElementById('forma4').checked) {
      document.envio.action =
        'funciones/consulta_estafi.php?nro=' + estafi + '&tipo=03&edit=1&pdf=1';
    } else if (document.getElementById('forma5').checked) {
      document.envio.action =
        'funciones/consulta_tipvia.php?nro=' + tipvia + '&tipo=03&edit=1&pdf=1';
    } else if (document.getElementById('forma7').checked) {
    ...
    if (document.getElementById('forma1').checked) {
      document.envio.action =
        'funciones/consulta_numero_2.php?nro=' + num + '&tipo=04&edit=1&pdf=1';
    } else if (document.getElementById('forma2').checked) {
      document.envio.action =
        'funciones/consulta_ref_2.php?nro=' + antiguo + '&tipo=04&edit=1&pdf=1';
    } else if (document.getElementById('forma3').checked) {
      document.envio.action = 'funciones/consulta_cuc_2.php?nro=' + cuc + '&tipo=04&edit=1&pdf=1';
    } else if (document.getElementById('forma4').checked) {
      document.envio.action =
        'funciones/consulta_estafi.php?nro=' + estafi + '&tipo=04&edit=1&pdf=1';
    } else if (document.getElementById('forma5').checked) {
      document.envio.action =
        'funciones/consulta_tipvia.php?nro=' + tipvia + '&tipo=04&edit=1&pdf=1';
    } else if (document.getElementById('forma6').checked) {
      document.envio.action =
        'funciones/consulta_tipopu.php?nro=' + tipopu + '&tipo=04&edit=1&pdf=1';
    } else if (document.getElementById('forma7').checked) {
      document.envio.action = 'funciones/consulta_tiphu.php?nro=' + tiphu + '&tipo=04&edit=1&pdf=1';
    } else if (document.getElementById('forma8').checked) {
      document.envio.action =
        'funciones/consulta_claspr.php?nro=' + claspr + '&tipo=04&edit=1&pdf=1';
    } else if (document.getElementById('forma9').checked) {
      document.envio.action =
        'funciones/consulta_predca.php?nro=' + predca + '&tipo=04&edit=1&pdf=1';
    } else if (document.getElementById('forma12').checked) {
...
function bloqueos(e) {
  if (e.name == 'forma1') {
    ...
    document.getElementById('referencia').disabled =
      !document.getElementById('referencia').disabled;
    ...
    document.getElementById('ic_cmb_estficha').disabled =
      !document.getElementById('ic_cmb_estficha').disabled;
    document.getElementById('upc_pue-0').disabled = !document.getElementById('upc_pue-0').disabled;
    document.getElementById('dp_cmb_precat').disabled =
      !document.getElementById('dp_cmb_precat').disabled;
    document.getElementById('itc_cmb_tipotitu').disabled =
      !document.getElementById('itc_cmb_tipotitu').disabled;
    document.getElementById('ct_cmb_condtitu').disabled =
      !document.getElementById('ct_cmb_condtitu').disabled;
    document.getElementById('dp_cmb_claspre').disabled =
      !document.getElementById('dp_cmb_claspre').disabled;
    document.getElementById('dftc_cmb_tipovia').disabled =
      !document.getElementById('dftc_cmb_tipovia').disabled;
    document.getElementById('cmb_tipohu').disabled =
      !document.getElementById('cmb_tipohu').disabled;
  ...
  if (e.name == 'forma6') {
    ...
    document.getElementById('cmb_tipohu').disabled =
      !document.getElementById('cmb_tipohu').disabled;
    document.getElementById('sector').disabled = !document.getElementById('sector').disabled;
    document.getElementById('opt_fichas_1').disabled =
      !document.getElementById('opt_fichas_1').disabled;
    document.getElementById('opt_fichas_3').disabled =
      !document.getElementById('opt_fichas_3').disabled;
  ...
  if (e.name == 'forma10') {
    ...
    document.getElementById('opt_fichas_3').disabled =
      !document.getElementById('opt_fichas_3').disabled;
    document.getElementById('opt_fichas_4').disabled =
      !document.getElementById('opt_fichas_4').disabled;
...
function ponerCeros(obj) {
  if (obj.value.length > 0) {
    while (obj.value.length < 7) obj.value = '0' + obj.value;
  }
}
