...
listadoSelects[0]="departamentos";
listadoSelects[1]="provincias";
listadoSelects[2]="distritos";
...
function cargaContenido(idSelectOrigen)
{
	...
	else if(idSelectOrigen!=listadoSelects[listadoSelects.length-1])
	{
		...
		var ajax=nuevoAjax();
		ajax.open("GET", "../funciones/cascade_proceso.php?select="+idSelectDestino+"&opcion="+opcionSeleccionada, true);
...
{	
	...
	else if(idSelectOrigen!=listadoSelects[listadoSelects.length-1])
	{
		...
		// Creo el nuevo objeto AJAX y envio al servidor el ID del select a cargar y la opcion seleccionada del select origen
		var ajax=nuevoAjax();
		ajax.open("GET", "../funciones/cascade_proceso2.php?select="+idSelectDestino+"&opcion="+opcionSeleccionada, true);
		ajax.onreadystatechange=function() 
		{ 
			if (ajax.readyState==1)
			{
