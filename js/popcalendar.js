...
//	email :	fuushikaden@yahoo.com
	...
	var	fixedX = 22 // x position (-1 if to appear below control)
	var	fixedY = -5 // y position (-1 if to appear below control)
...
//	var imgDir = "../../imagenes/"	// directory for images ... e.g. var imgDir="/img/"
    ...
    */
	...
	if (dom)
	{
		...
		document.write ("<div onclick='bShow=true' id='calendar'	class='div-style'><table width="+((showWeekNumber==1)?250:220)+" class='table-style'><tr class='title-background-style' ><td><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td class='title-style'><B><span id='caption'></span></B></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' WIDTH='15' HEIGHT='13' BORDER='0' ALT='Cerrar Calendario'></a></td></tr></table></td></tr><tr><td class='body-style'><span id='content'></span></td></tr>")
	...
	function popUpCalendar(ctl,	ctl2, format) {
		...
		if (bPageLoaded)
		{
			if ( crossobj.visibility ==	"hidden" ) {
				...
				crossobj.left =	fixedX==-1 ? ctl.offsetLeft	+ leftpos :	fixedX + leftpos
				crossobj.top = fixedY==-1 ?	ctl.offsetTop +	toppos + ctl.offsetHeight +	2 :	fixedY + toppos
