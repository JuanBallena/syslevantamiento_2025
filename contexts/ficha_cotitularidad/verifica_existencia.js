...
function nro_cotitulares() {
  ...
  //PARA AMBOS CASOS---------------------------------------
  if (Number(nro_titulares) < 2) {
    alert('Ingrese Nro. de Titulares - (Minimo 2)');
    ...
    if (directo == '1') {
      ...
      document.envio.action = 'FichaCotitularidad.php?titu=' + nro_titulares;
    } else if (directo == '0') {
      var sw = 0;
        ...
        ajax.onreadystatechange = function () {
          if (ajax.readyState == 4) {
            ...
            if (valor == '0') {
              ...
              return false;
            } //existe MÁS de UNA FICHA
            else {
              //pasa sólo en IE mas no con FIREFOX
              location.href =
                'FichaCotitularidad.php?titu=' + nro_titulares + '&nro=' + nro_ficha + '&cr=' + cr;
