...
<?php 
	...
	$Consulta="SELECT id_sector,id_ubi_geo,codi_sector,nomb_sector FROM tf_sectores;";
...
<table width='100%' border="0" bgcolor="#FFFFFF" cellspacing='3px' cellpadding="3">
	...
	<thead> 
	 <tr><th colspan="3"><div align="center" class="Estilo7"><strong>SECTORES</strong></div></th></tr>
     <tr bgcolor="#BFDFFF">
   ...
   <?php
	...
	?>     
	  <tr bgcolor="#BFDFFF">
  				...
  				<td><div class='Estilo7' align="center"><?php echo $row1['codi_sector']; ?></div></td>
              
                <td><div class='Estilo7' align="center"><?php echo $row1['nomb_sector']; ?></div></td>                
