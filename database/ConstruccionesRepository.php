...
class ConstruccionesRepository
{
  ...
  public function guardarConstruccionesMultiple(array $data): int
  {
    $placeholders = [];
    $params = [];
    $count = 1;
    ...
    //   throw new Exception("❌ Error al guardar lote o no se obtuvo id_lote.");
    // }
