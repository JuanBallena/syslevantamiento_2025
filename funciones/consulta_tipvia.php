...
$edit=$_GET['edit'];
   ...
   <?php 
	...
	$Consulta="SELECT distinct f.id_ficha, f.tipo_ficha, f.nume_ficha, f.fecha_levantamiento,  ".
			"p.ape_paterno||' '||p.ape_materno||' '||p.nombres as titular, t.nume_titular  ".
			...
			"LEFT JOIN tf_ingresos as i ON f.id_ficha = i.id_ficha ".  
			"INNER JOIN tf_puertas as l on i.id_puerta = l.id_puerta ".
			"inner join tf_vias as m on m.id_via = l.id_via ".
			"WHERE  f.tipo_ficha='$tipo' AND m.tipo_via ='$tipvia' ".
