...
$pdf=$_GET['pdf'];
   ...
   <?php 
	...
	/*$Consulta="SELECT f.id_uni_cat, f.tipo_ficha, f.nume_ficha, f.fecha_levantamiento, ".
			...
			"FROM tf_fichas as f  ".
			//"LEFT OUTER JOIN tf_uni_cat as u ON f.id_uni_cat =u.id_uni_cat ".
			//"LEFT OUTER JOIN tf_edificaciones as e ON u.id_edificacion = e.id_edificacion  ".			
