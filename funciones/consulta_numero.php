...
$edit=$_GET['edit'];	
   ...
   <?php 
	...
	$cmdtuples = pg_num_rows($consulta_1);

	while($row1=pg_fetch_array($consulta_1))
	
	{ 	
			//echo "el row 1 esss ahora  =".$row1['tipo_ficha'];
		...
		if($pinta%2==0)
		  ...
		  ?>          
				...
				?>">
                <img src="../img/editar.png" width="16" height="13" border="0" title="Editar Ficha"/></a></div></td>
		<?php 
