...
$pdf=$_GET['pdf'];
	...
	<thead> 
     <tr>
       ...
       <th width="300px" rowspan="1" bgcolor="#0052A4"><div align="center" class="Estilo5">Datos del Conductor</div></th>
   ...
   <?php 
	...
	$Consulta="SELECT f.id_uni_cat, f.tipo_ficha, f.nume_ficha, f.fecha_levantamiento, ".
			"p.ape_paterno||' '||p.ape_materno||' '||p.nombres as titular, f.id_ficha ".
			"FROM tf_fichas as f LEFT OUTER JOIN tf_conductores as t ON f.id_ficha = t.id_ficha ".
			"LEFT OUTER JOIN public.tf_personas as p ON t.id_persona = p.id_persona ".
			"WHERE f.id_uni_cat ='$ref' ".
