...
$pdf=$_GET['pdf'];
   ...
   <?php 
	...
	/*$Consulta="SELECT f.id_uni_cat, f.tipo_ficha, f.nume_ficha, f.fecha_levantamiento, ".
			...
			"FROM tf_fichas as f  ".
			"LEFT OUTER JOIN tf_fichas_individuales i ON f.id_ficha =i.id_ficha ".
			"LEFT OUTER JOIN tf_titulares as t ON f.id_ficha = t.id_ficha ".
			"LEFT OUTER JOIN public.tf_personas as p ON t.id_persona = p.id_persona ".
			"WHERE i.esta_llenado='$estafi'".
...
*/
	...
	//echo 'tipo Ficha: '.$_GET['tipo'].'estado'.$_GET['nro']; 
	...
	elseif	($_GET['tipo']='02'){
			$Consulta="SELECT f.id_uni_cat, f.tipo_ficha, f.nume_ficha, f.fecha_levantamiento, ".
							"p.ape_paterno||' '||p.ape_materno||' '||p.nombres as titular, t.nume_titular, f.id_ficha ".
							"FROM tf_fichas as f  ".
							"LEFT OUTER JOIN tf_fichas_cotitularidades i ON f.id_ficha =i.id_ficha ".
							"LEFT OUTER JOIN tf_titulares as t ON f.id_ficha = t.id_ficha ".
							"LEFT OUTER JOIN public.tf_personas as p ON t.id_persona = p.id_persona ".
							"WHERE i.esta_llenado='$estafi'".
							"AND f.tipo_ficha='$tipo'".
	...
	elseif	($_GET['tipo']='03'){
			$Consulta="SELECT f.id_uni_cat, f.tipo_ficha, f.nume_ficha, f.fecha_levantamiento, ".
							"p.ape_paterno||' '||p.ape_materno||' '||p.nombres as titular, t.nume_titular, f.id_ficha ".
							"FROM tf_fichas as f  ".
							"LEFT OUTER JOIN tf_fichas_economicas i ON f.id_ficha =i.id_ficha ".
							"LEFT OUTER JOIN tf_titulares as t ON f.id_ficha = t.id_ficha ".
							"LEFT OUTER JOIN public.tf_personas as p ON t.id_persona = p.id_persona ".
							"WHERE i.esta_llenado='$estafi'".
							"AND f.tipo_ficha='$tipo'".
	...
	elseif	($_GET['tipo']='04'){			
			$Consulta="SELECT f.id_uni_cat, f.tipo_ficha, f.nume_ficha, f.fecha_levantamiento, ".
							"p.ape_paterno||' '||p.ape_materno||' '||p.nombres as titular, t.nume_titular, f.id_ficha ".
							"FROM tf_fichas as f  ".
							"LEFT OUTER JOIN tf_fichas_bienes_comunes i ON f.id_ficha =i.id_ficha ".
							"LEFT OUTER JOIN tf_titulares as t ON f.id_ficha = t.id_ficha ".
							"LEFT OUTER JOIN public.tf_personas as p ON t.id_persona = p.id_persona ".
							"WHERE i.esta_llenado='$estafi'".
							"AND f.tipo_ficha='$tipo'".
