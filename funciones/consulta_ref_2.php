...
$pdf=$_GET['pdf'];
	...
	$BaseDato->conectar();
	$Consulta="SELECT f.id_uni_cat, f.tipo_ficha, f.nume_ficha, f.fecha_levantamiento, ".
      ...
      "LEFT OUTER JOIN public.ext_fichas_codigos_antiguos as a ON f.id_ficha = a.id_ficha ".
			"WHERE a.codigo_catastral ='$ref' ".
  ...
  if (pg_num_rows($consulta_1) == 0) {
    echo "No existe ese registro para el tipo de Ficha seleccionada.";
  }
  else if (pg_num_rows($consulta_1) > 0) {  
      ...
      if($pinta%2==0)
            ...
            ?>">
                ...
                {	case '01':	
                        if($pdf=='1')
                          ...
                          break;
                  case '02':	if($pdf=='1')
                          echo "../fichaCotitularidad/Reporte/pdf.php?id=".$row1['id_ficha'];
                        else
          ...
          <tbody> 
            ...
            ?>"> <img src="../img/editar.png" width="16" height="13" border="0" title="Editar Ficha"/></a>
                ...
                {	case '01':	
                        if($pdf=='1')
                          echo "../fichaIndividual/Reporte_individual/pdf.php?id=".$row1['id_ficha'];
                        else	
                          echo "../fichaIndividual/modifica_individual.php?id=".$row1['id_ficha'];
                          break;
                  case '02':	if($pdf=='1')
                  ...
                  case '04':	if($pdf=='1')
                          echo "../fichaBienComun/Reporte_bc/pdf.php?id=".$row1['id_ficha'];
                        else
                          echo "../fichaBienComun/modifica_biencomun.php?id=".$row1['id_ficha'];
                        break;
                }
