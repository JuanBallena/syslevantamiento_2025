...
$edit=$_GET['edit'];
   ...
   <?php 
	...
	$Consulta="SELECT distinct f.id_ficha, f.tipo_ficha, f.nume_ficha, f.fecha_levantamiento, ". 
			...
			"INNER JOIN tf_lotes as l on l.id_lote = f.id_lote ".
			"INNER JOIN TF_HAB_URBANA as h on h.codi_hab_urba = l.id_hab_urba ".
			"WHERE  h.tipo_hab_urba ='$tiphu' and f.tipo_ficha='$tipo' ". 
