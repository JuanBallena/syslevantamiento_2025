...
$FichaNueva = $oFichaNueva->ObtenerFichaNueva_Unidades($UniCat);
  ...
  <script> 
    ...
    window.onload = () => {
        ...
        loadInputValuesCatastralReferenceCode({
            district: <?php echo json_encode(substr($FichaNueva['c_id_uni_cat'], 4, 2)); ?>,
            sector:   <?php echo json_encode(substr($FichaNueva['c_id_uni_cat'], 6, 2)); ?>,
            manzana:  <?php echo json_encode(substr($FichaNueva['c_id_uni_cat'], 8, 3)); ?>,
            lote:     <?php echo json_encode(substr($FichaNueva['c_id_uni_cat'], 12, 3)); ?>
        ...
        loadVias(<?php echo json_encode($ViaPuerta) ?>);
