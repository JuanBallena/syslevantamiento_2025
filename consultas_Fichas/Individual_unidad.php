...
<div class="o-main">
  ...
  <script> 
    ...
    window.onload = () => {
        ...
        loadInputValuesCatastralReferenceCode_Unidad({
            edifica:  <?php echo json_encode(substr($loteF['c_id_uni_cat'],14,2)); ?>,
            entrada:  <?php echo json_encode(substr($loteF['c_id_uni_cat'],16,2)); ?>,
            piso:     <?php echo json_encode(substr($loteF['c_id_uni_cat'],18,2)); ?>,
