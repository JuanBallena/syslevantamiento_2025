...
require_once 'E_verificar_insertar.php';
...
echo "<meta http-equiv='refresh' content='1;url=http://".$_SERVER['HTTP_HOST']."/syslevantamiento/fichaActividadEconomica/nro_economica.php'/>";
