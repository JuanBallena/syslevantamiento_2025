...
<form name="envio" method="post"  onsubmit="javascript: return verifica_economica();" autocomplete="off">
  <table width="980" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td>
    <table class="myform" width="680" border="0" >
        <tr>
          <td width="486" colspan="3" bgcolor="#0052A4"><div align="center">
            <p class="Estilo1"> FICHA CATASTRAL ACTIVIDAD ECON&Oacute;MICA</p>
            </div></td>
        </tr>
        <tr>
						 ...
						 <tr><td>&nbsp;</td></tr>
						  <tr>
						    ...
						    <td colspan='11'><div align='left'>
                              <input  type='text' name='nro_ficha' id='nro_ficha' maxlength='7' size='7' style='text-align:center' onkeypress='javascript:return validar_numeros(event)' onchange='javascript:valida_nro_ficha_E(this)' />
                            </div></td>
						  </tr>
