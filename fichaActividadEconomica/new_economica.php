...
include 'proceso_eco/E_combos.php';
...
{	$rpta=1;
	...
	//para saber si viene un NATURAL o JURIDICO
	$ic_0=$_SESSION['itc_cmb_tipotitu'];
		if($ic_0==1) $tipo_persona=1;
		else $tipo_persona=2;
		
	$ic_1=$_SESSION['itc_numdoc'];
	$ic_2=$_SESSION['itc_nombre'];
	$ic_3=$_SESSION['itc_paterno'];
	$ic_4=$_SESSION['itc_materno'];
	$ic_5=$ic_3.' '.$ic_4.' '.$ic_2;

	$ic_6=$_SESSION['itc_ruc'];
	$ic_7=$_SESSION['itc_razsocial'];


	$dfc1=$_SESSION['departamentos'];
	$dfc2=$_SESSION['provincias'];
	$dfc3=$_SESSION['istritos'];
	$dfc4=$_SESSION['dftc_telf'];
	$dfc5=$_SESSION['dftc_anexo'];
	$dfc6=$_SESSION['dftc_fax'];
	$dfc7=$_SESSION['dftc_email'];
	$dfc8=$_SESSION['dftc_codvia'];
	$dfc9=$_SESSION['dftc_tipovia'];
	$dfc10=$_SESSION['dftc_nomvia'];
	$dfc11=$_SESSION['dftc_nummuni'];
	$dfc12=$_SESSION['dftc_nomedi'];
	$dfc13=$_SESSION['ftc_numint'];
	$dfc14=$_SESSION['dftc_codhu'];
	$dfc15=$_SESSION['dftc_nomhu'];
	$dfc16=$_SESSION['dftc_zse'];
	$dfc17=$_SESSION['dftc_mzna'];
	$dfc18=$_SESSION['dftc_lote'];
	$dfc19=$_SESSION['dftc_sublote'];
}
else 
{ 
	$rpta=2;
...
<div align="center">
<form  class="myform" name="datos" action="proceso_eco/E_graba_economica.php"  method="post" onSubmit="return datos_minimos_economica()" autocomplete="off">
                            ...
                            <table width="630" border="0" cellpadding="0" cellspacing="0" class="tabla" style="vertical-align:middle">
                              ...
                              <tr>
                                ...
                                <td height="24" colspan="13"><input name="contador1" type="text" class="contador" id="contador1" value="0" size="2" maxlength="2"/>
                                    ...
                                    <input name="total" type="text" class="contador" id="total" value="<?php echo $nro_titulares;?>" size="2" maxlength="2"/>                                    <input name="conductor" type="text" class="contador" id="conductor" value="<?php echo $tipo_persona;?>" size="2" maxlength="2"/>
                                    </td>
                                </tr>
                            </table>
                          </div></td>
								...
								<table  id="oculta" width="100%" align="center" cellpadding="0" cellspacing="0" class="tabla">
                                    <tr>
                                      ...
                                      <td><span class="etiqueta">
                                        <input type="text" class="casilla" name="ic_nomcom" value="" size="40" id="ic_nomcom" 
...
<td width="289"><span class="etiqueta">
                                    <?php 
										if($rpta==1)
										{
											if($ic_0==1)//natural
											{
												echo "<input type='text' class='casilla' name='ic_nrodoc' id='ic_nrodoc' value='".$ic_1."' size='9' onKeyPress='return validar_numeros(event)'/>
											</span></td>
										</tr>
										<tr>
                                      ...
                                      <td height='24' class='etiqueta'><input type='text' class='casilla' name='ic_ruc' value='' size='20' maxlength='11' id='ic_ruc' onKeyPress='return validar_numeros(event)'/></td>
                                    ...
                                    <tr>
                                      ...
                                      <td height='24' colspan='2' class='etiqueta'><input name='ape_paterno' type='text' class='casillaLarga' value='".$ic_3."' size='20' id='ape_paterno' onkeyup='validar_todo_mayus(this)'/>
                                        <input name='ape_materno' type='text' class='casillaLarga' value='".$ic_4."' size='20' id='ape_materno' onkeyup='validar_todo_mayus(this)'/></td>
                                      <td height='24' class='etiqueta'><em>NOMBRES</em></td>
                                      <td height='24' class='etiqueta'><input name='nombres' type='text' class='casillaLarga' value='".$ic_2."' size='40' id='nombres' onkeyup='validar_todo_mayus(this)'/></td>
                                    </tr>
                                    <tr>
                                      <td height='24' class='etiqueta'></td>
                                      <td height='24' class='etiqueta'><em>RAZÓN SOCIAL</em></td>
                                      <td height='24' class='etiqueta'><input name='ic_razsocial' type='text' class='casillaLarga' value='' size='46' id='ic_razsocial' onkeyup='validar_todo_mayus(this)'/></td>
                                      <td height='24' class='etiqueta'></td>
                                      <td height='24' class='etiqueta'></td>
                                      <td height='24' class='etiqueta'></td>";
											}
											...
											{
												echo "<input type='text' class='casilla' name='ic_nrodoc' id='ic_nrodoc' value='' size='9' onKeyPress='return validar_numeros(event)'/>
											</span></td>
										</tr>
										<tr>
                                        <td height='24' class='etiqueta'><div align='center'><img src='../img/casilla_azul/31.png' alt='Guardar estado?' width='17' height='17' border='0' /></div></td>
                                        <td height='24' class='etiqueta'>N° DE R.U.C.</td>
                                      <td height='24' class='etiqueta'><input type='text' class='casilla' name='ic_ruc' value='".$ic_6."' size='20' maxlength='11' id='ic_ruc' onKeyPress='return validar_numeros(event)'/></td>
                                        <td height='24' class='etiqueta'><div align='center'></div></td>
                                        <td height='24' class='etiqueta'></td>
                                      <td height='24' class='etiqueta'></td>
									</tr>
                                    ...
                                    <tr>
                                      <td height='24' class='etiqueta'></td>
                                      <td height='24' class='etiqueta'><em>AP. PATERNO Y  AP. MATERNO</em></td>
                                      <td height='24' colspan='2' class='etiqueta'><input name='ape_paterno' type='text' class='casillaLarga' value='' size='20' id='ape_paterno' onkeyup='validar_todo_mayus(this)'/>
                                        <input name='ape_materno' type='text' class='casillaLarga' value='' size='20' id='ape_materno' onkeyup='validar_todo_mayus(this)'/></td>
                                      <td height='24' class='etiqueta'><em>NOMBRES</em></td>
                                      <td height='24' class='etiqueta'><input name='nombres' type='text' class='casillaLarga' value='' size='40' id='nombres' onkeyup='validar_todo_mayus(this)'/></td>
                                    </tr>
                                    <tr>
                                      <td height='24' class='etiqueta'></td>
                                      <td height='24' class='etiqueta'><em>RAZÓN SOCIAL</em></td>
                                      <td height='24' class='etiqueta'><input name='ic_razsocial' type='text' class='casillaLarga' value='".$ic_7."' size='46' id='ic_razsocial' onkeyup='validar_todo_mayus(this)'/></td>
                                      <td height='24' class='etiqueta'></td>
                                      <td height='24' class='etiqueta'></td>
                                      <td height='24' class='etiqueta'></td>";
										...
										{?>
										<input type="text" class="casilla" name="ic_nrodoc" id="ic_nrodoc" value="" size="9" onKeyPress="return validar_numeros(event)"/>
                                        </span></td>
                                    </tr>
                                    <tr>
                                        <td height='24' class='etiqueta'><div align='center'><img src='../img/casilla_azul/31.png' alt='Guardar estado?' width='17' height='17' border='0' /></div></td>
  ...
  <tr>
	...
	<table width="950px" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla">
                      ...
                      <td width='282'>
                        <input type='text' class='casilla' name='dftc_telf' value='".$dfc4."' readonly size='10' maxlength='12' id='dftc_telf' onKeyUp='validar_todo_mayus(this)'/> </td>
                          <td width='23' height='24' class='etiqueta'><div align='center'><img src='../img/casilla_azul/43.png' alt='Guardar estado?' width='17' height='17' border='0' /></div></td>
                            ...
                            <td>
                                <input type='text' class='casilla' name='dftc_anexo' value='".$dfc5."' readonly size='2' maxlength='8' id='dftc_anexo' onKeyUp='validar_todo_mayus(this)'/></td>
                        </tr>
                        <tr>
                          ...
                          <td height='24' class='etiqueta'>FAX</td>
                            <td>
                                <input type='text' class='casilla' name='dftc_fax' value='".$dfc6."' readonly size='10' maxlength='12' id='dftc_fax' /></td>
                            ...
                            <td>
                                <input name='dftc_email' type='text' class='casillaLarga' id='dftc_email' value='".$dfc7."' readonly size='40' onKeyUp='EmailCheck(this)'/>  </td>
                        </tr>
                        <tr>
                          ...
                          <td height='24' class='etiqueta'>C&Oacute;DIGO DE V&Iacute;A</td>
                            <td>
                                <input type='text' class='casilla' name='dftc_codvia' value='".$dfc8."' readonly size='5' maxlength='6' id='dftc_codvia' onChange='trae_via(this)'/></td>
                          <td height='24' class='etiqueta'><div align='center'><img src='../img/casilla_azul/8.png' alt='Guardar estado?' width='17' height='17' border='0' /></div></td>
                            ...
                            <td><input class='input'  id='dftc_tipovia' name='dftc_tipovia' value='".$dfc9."' type='text' size='5'  readonly/></td>
              </tr>
                        <tr>
                          ...
                          <td height='24' class='etiqueta'>NOMBRE DE V&Iacute;A</td>
                            <td>
                                <input name='dftc_nomvia' type='text' class='casillaLarga' value='".$dfc10."' readonly size='32' id='dftc_nomvia' readonly/> </td>
                            ...
                            <td>
                                <input type='text' class='casilla' name='dftc_nummuni' value='".$dfc11."' readonly size='5' maxlength='6' id='dftc_nummuni'/> </td>
                        </tr>
                        <tr>
                          ...
                          <td height='24' class='etiqueta'>NOMBRE DE EDIFICACI&Oacute;N</td>
                            <td>
                                <input name='dftc_nomedi' type='text' class='casillaLarga' id='dftc_nomedi' value='".$dfc12."' readonly size='32' ".$M."/> </td>
                            ...
                            <td>
                                <input type='text' class='casilla' name='dftc_numint' value='".$dfc13."' readonly size='2' maxlength='4' id='dftc_numint'/>  </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type='text' class='casilla' name='dftc_codhu' value='".$dfc14."' readonly size='2' maxlength='4' id='dftc_codhu' onChange='trae_HU2(this)'/></td>
                            ...
                            <td>
                                <input name='dftc_nomhu' type='text' class='casillaLarga' value='".$dfc15."' size='40' id='dftc_nomhu' readonly/></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type='text' class='casilla' name='dftc_zse' value='".$dfc16."' readonly size='20' maxlength='20' id='dftc_zse' ".$M."/> </td>
                            ...
                            <td>
                                <input type='text' class='casilla' name='dftc_mzna' value='".$dfc17."' readonly size='2' maxlength='3' id='dftc_mzna' ".$M."/></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type='text' class='casilla' name='dftc_lote' value='".$dfc18."' readonly size='2' maxlength='5' id='dftc_lote'/></td>
                            ...
                            <td>
                                <input type='text' class='casilla' name='dftc_sublote' value='".$dfc19."' readonly size='2' maxlength='6' id='dftc_sublote' ".$M."/></td>
                        </tr>";
						...
						{ //imprime normal
						 ?>
                          ...
                          <td width="282">
                            <input type="text" class="casilla" name="dftc_telf" value="" size="10" maxlength="12" id="dftc_telf" onKeyUp="validar_todo_mayus(this)"/> </td>
                              <td width="23" height="24" class="etiqueta"><div align="center"><img src="../img/casilla_azul/43.png" alt="Guardar estado?" width="17" height="17" border="0" /></div></td>
                                <td width="200" height="24" class="etiqueta">ANEXO</td>
                                <td>
                                    <input type="text" class="casilla" name="dftc_anexo" value="" size="2" maxlength="8" id="dftc_anexo" onKeyUp="validar_todo_mayus(this)"/></td>
                            </tr>
                            <tr>
                                <td height="24" class="etiqueta"><div align="center"><img src="../img/casilla_azul/44.png" alt="Guardar estado?" width="17" height="17" border="0" /></div></td>
                              <td height="24" class="etiqueta">FAX</td>
                                <td>
                                    <input type="text" class="casilla" name="dftc_fax" value="" size="10" maxlength="12" id="dftc_fax" /></td>
                                <td height="24" class="etiqueta"><div align="center"><img src="../img/casilla_azul/45.png" alt="Guardar estado?" width="17" height="17" border="0" /></div></td>
                                <td height="24" class="etiqueta">CORREO ELECTR&Oacute;NICO</td>
                                <td>
                                    <input name="dftc_email" type="text" class="casillaLarga" id="dftc_email" value="" size="40" onKeyUp="EmailCheck(this)"/>  </td>
                            </tr>
                            <tr>
                                <td height="24" class="etiqueta"><div align="center"><img src="../img/casilla_azul/7.png" alt="Guardar estado?" width="17" height="17" border="0" /></div></td>
                              <td height="24" class="etiqueta">C&Oacute;DIGO DE V&Iacute;A</td>
                                <td>
                                    <input type="text" class="casilla" name="dftc_codvia" value="" size="5" maxlength="6" id="dftc_codvia" onChange="trae_via(this)"/></td>
                              <td height="24" class="etiqueta"><div align="center"><img src="../img/casilla_azul/8.png" alt="Guardar estado?" width="17" height="17" border="0" /></div></td>
                                <td height="24" class="etiqueta">TIPO DE V&Iacute;A</td>
                            ...
                            <tr>
                              ...
                              <td height="24" class="etiqueta">NOMBRE DE V&Iacute;A</td>
                                <td>
                                    <input name="dftc_nomvia" type="text" class="casillaLarga"value="" size="32" id="dftc_nomvia" readonly/> </td>
                                <td height="24" class="etiqueta"><div align="center"><img src="../img/casilla_azul/11.png" alt="Guardar estado?" width="17" height="17" border="0" /></div></td>
                                <td height="24" class="etiqueta">N&Uacute;MERO MUNICIPAL</td>
                                <td>
                                    <input type="text" class="casilla" name="dftc_nummuni" value="" size="5" maxlength="6" id="dftc_nummuni"/> </td>
                            </tr>
                            <tr>
                                <td height="24" class="etiqueta"><div align="center"><img src="../img/casilla_azul/14.png" alt="Guardar estado?" width="17" height="17" border="0" /></div></td>
                              <td height="24" class="etiqueta">NOMBRE DE EDIFICACI&Oacute;N</td>
                                <td>
                                    <input name="dftc_nomedi" type="text" class="casillaLarga" id="dftc_nomedi" value="" size="32" <?php echo $M;?>/> </td>
                                <td height="24" class="etiqueta"><div align="center"><img src="../img/casilla_azul/17.png" alt="Guardar estado?" width="17" height="17" border="0" /></div></td>
                                <td height="24" class="etiqueta">N&Uacute;MERO INTERIOR</td>
                                <td>
                                    <input type="text" class="casilla" name="dftc_numint" value="" size="2" maxlength="4" id="dftc_numint"/>  </td>
                            </tr>
                            <tr>
                                <td height="24" class="etiqueta"><div align="center"><img src="../img/casilla_azul/18.png" alt="Guardar estado?" width="17" height="17" border="0" /></div></td>
                                <td height="24" class="etiqueta">C&Oacute;DIGO H.U.</td>
                                <td>
                                    <input type="text" class="casilla" name="dftc_codhu" value="" size="2" maxlength="4" id="dftc_codhu" onChange="trae_HU2(this)"/></td>
                                <td height="24" class="etiqueta"><div align="center"><img src="../img/casilla_azul/19.png" alt="Guardar estado?" width="17" height="17" border="0" /></div></td>
                                <td height="24" class="etiqueta">NOMBRE DE LA H.U.</td>
                                <td>
                                    <input name="dftc_nomhu" type="text" class="casillaLarga"value="" size="40" id="dftc_nomhu" readonly/></td>
                            </tr>
                            <tr>
                                <td height="24" class="etiqueta"><div align="center"><img src="../img/casilla_azul/20.png" alt="Guardar estado?" width="17" height="17" border="0" /></div></td>
                                <td height="24" class="etiqueta">ZONA/SECTOR/ETAPA</td>
                                <td>
                                    <input type="text" class="casilla" name="dftc_zse" value="" size="20" maxlength="20" id="dftc_zse" <?php echo $M;?>/> </td>
                                <td height="24" class="etiqueta"><div align="center"><img src="../img/casilla_azul/21.png" alt="Guardar estado?" width="17" height="17" border="0" /></div></td>
                                <td height="24" class="etiqueta">MANZANA</td>
                                <td>
                                    <input type="text" class="casilla" name="dftc_mzna" value="" size="2" maxlength="3" id="dftc_mzna" <?php echo $M;?>/></td>
                            </tr>
                            <tr>
                                <td height="26" class="etiqueta"><div align="center"><img src="../img/casilla_azul/22.png" alt="Guardar estado?" width="17" height="17" border="0" /></div></td>
                                <td height="26" class="etiqueta">LOTE</td>
                                ...
                                <td height="26" class="etiqueta">SUB-LOTE</td>
                                <td>
                                    <input type="text" class="casilla" name="dftc_sublote" value="" size="2" maxlength="6" id="dftc_sublote" <?php echo $M;?>/></td>
                            </tr>
						<?php
						//cerramos el ELSE
						} //----------------------------------------------------------------------------------------------------------------------
              ...
              <tr>
                <td><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla">
                      ...
                      <td colspan="6" valign="top"><table border="1" align="center" bordercolor="#ECE9D8" cellpadding="0" cellspacing="0"  class="tabla">
                          ...
                          <tbody>
                            <tr class="normal">
                              ...
                              <td align="center"><input style="text-align:center" name="au_predcat" type="text" id="au_predcat"  value="" maxlength="10" <?php echo $Ncoma;?>/></td>
                              <td align="center"><input style="text-align:center" name="au_viapub" type="text" id="au_viapub" value="" maxlength="10" <?php echo $Ncoma;?>/></td>
                              <td align="center"><input style="text-align:center" name="au_bc" type="text" id="au_bc" maxlength="10" ovalue="" <?php echo $Ncoma;?>/></td>
                              <td align="center"><input style="text-align:center" name="au_total" type="text" id="au_total" maxlength="10" ovalue="" <?php echo $Ncoma;?>/></td>
                            </tr>
                            <tr class="normal">
                              ...
                              <td align="center"><input style="text-align:center" type="text"  name="av_predcat" value="" maxlength="10" id="av_predcat" <?php echo $Ncoma;?>/>                              </td>
                              <td align="center"><input style="text-align:center" type="text" name="av_viapub" value="" maxlength="10" id="av_viapub" <?php echo $Ncoma;?>/></td>
                              <td align="center"><input style="text-align:center" type="text"  name="av_bc" value="" maxlength="10" id="av_bc" <?php echo $Ncoma;?>/></td>
                              <td align="center"><input style="text-align:center" name="av_total" type="text" id="av_total" maxlength="10" ovalue="" <?php echo $Ncoma;?>/></td>
                            </tr>
                          </tbody>
                      </table></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td width="320"><input  name="aae_nroexp" type="text" id="aae_nroexp" value="" maxlength="10" <?php echo $N;?>/>                      </td>
                      ...
                      <td><input type="text" name="aae_numlic"  id="aae_numlic" value="" maxlength="10" <?php echo $N;?>/>                      </td>
                </tr>
                     <tr>
                      <td class="etiqueta" colspan="6">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td width="320"><input  name="aae_fecexp" id="aae_fecexp" type="text" value="" size="15" maxlength="10" <?php echo $VF;?>/>
                      ...
                      <td><input  name="aae_fecven"  id="aae_fecven" type="text" value="" size="15" maxlength="10" <?php echo $VF;?>/>
                    ...
                    <tr>
                      ...
                      <td colspan="4"><input  name="aae_iniact"  id="aae_iniact" type="text" value="" size="15" maxlength="10" <?php echo $VF;?>/>
                ...
                <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla">
                    ...
                    <tr>
                      <td colspan="4" valign="top"><table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#ECE9D8" class="tabla">
                          ...
                          <tr>
                            <td colspan="13"><div id="linea7_0"  style="width:950">
                                        <?php generaCombo(43); ?>
                                        <input  name="aa_nrolad-0" type="text"  maxlength="2" id="aa_nrolad-0"  style="width:50px; text-align:center;" <?php echo $N;?>/>
                                        <input name="aa_aaa-0" type="text" value="" maxlength="10" id="aa_aaa-0" <?php echo $Ncoma;?> style="width:140px; text-align:center;"/>
                                <input  class="input" name="aa_ava-0" type="text" id="aa_ava-0" <?php echo $Ncoma;?> style="width:135px; text-align:center;"/>
                              <input  class="input" name="aa_nroexp-0" type="text" id="aa_nroexp-0" <?php echo $N;?> style="width:75px; text-align:center;"/>
                              <input  class="input" name="aa_nrolic-0" type="text" id="aa_nrolic-0" <?php echo $N;?> style="width:65px; text-align:center;"/>
                              <input  class="input" name="aa_fecexp-0" type="text" id="aa_fecexp-0" maxlength="10" <?php echo $VF;?> style="width:110px"/>
                              <input  class="input" name="aa_fecven-0" type="text" id="aa_fecven-0" maxlength="10" <?php echo $VF;?> style="width:120px"/>
   ...
   <tr>
	...
	<input name='bandera' type='text' class='contador' id='bandera' size='2' maxlength='2'/>
	<br>
</div>
</form>
</div>
